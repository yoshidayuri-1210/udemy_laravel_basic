                    ...
                    <div class="container px-5 mx-auto">
                        ...
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="radio" name="gender" value="0" {{ (int)old('gender') === 0 ? 'checked' : '' }}>男性
                                <input type="radio" name="gender" value="1" {{ (int)old('gender') === 1 ? 'checked' : '' }}>女性
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <select name="age">
                                    ...
                                    <option value="1" {{ (int)old('age') === 1 ? 'selected' : '' }}>〜19歳</option>
                                    <option value="2" {{ (int)old('age') === 2 ? 'selected' : '' }}>20歳〜29歳</option>
                                    <option value="3" {{ (int)old('age') === 3 ? 'selected' : '' }}>30歳〜39歳</option>
                                    <option value="4" {{ (int)old('age') === 4 ? 'selected' : '' }}>40歳〜49歳</option>
                                    <option value="5" {{ (int)old('age') === 5 ? 'selected' : '' }}>50歳〜59歳</option>
                                    <option value="6" {{ (int)old('age') === 6 ? 'selected' : '' }}>60歳〜</option>
                                </select>
                            </div>
                            </div>
